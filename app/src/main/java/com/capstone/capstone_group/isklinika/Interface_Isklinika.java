...
public interface Interface_Isklinika {
    ...
    void dataInChildren(ArrayList<Class_StudentInfo> childrenInfo) ;  //This function is used to populate the recyclerview that shows the icons of the children. used when userType == Parent
